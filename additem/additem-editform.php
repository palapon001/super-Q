    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <form method="post" action="additem-edit-db.php">
                ...
                <input class="mt-3 form-control" type="number" name="Moisture" value="<?php echo $Moisture; ?>" required />
                ...
                <input class="mt-3 form-control" type="text" name="seller" placeholder="กรอกชื่อ-นามสกุล" value="<?php echo $seller; ?>" />
